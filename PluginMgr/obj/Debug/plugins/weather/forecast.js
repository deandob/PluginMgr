                ...
                parseForecast(result, function (err, jsonFcst) {
                    if (err !== null) {
                        ...
                        for (var day = 0; day < forecast.length; day++) {
                            ...
                            fw.toHost(fw.channels[0 + chOffset].name, fw.channels[0 + chOffset].units, summary);
                            fw.toHost(fw.channels[1 + chOffset].name, fw.channels[1 + chOffset].units, precis);
                            fw.toHost(fw.channels[2 + chOffset].name, fw.channels[2 + chOffset].units, min);
                            fw.toHost(fw.channels[3 + chOffset].name, fw.channels[3 + chOffset].units, max);
                            fw.toHost(fw.channels[4 + chOffset].name, fw.channels[4 + chOffset].units, icon);
                            if (day === 0) {
                                fw.toHost(fw.channels[5 + chOffset].name, fw.channels[2 + chOffset].units, precipRange);
                                fw.toHost(fw.channels[6 + chOffset].name, fw.channels[3 + chOffset].units, probability);
                            }
                        }
                    }
                    ...
                    for (var i = 0; i < 7; i++) {
                        ...
                        fw.toHost(fw.channels[37 + i].name, fw.channels[37 + i].units, daysWeek[newDate.getDay()]);     // Publish day names of forecast
                    }
